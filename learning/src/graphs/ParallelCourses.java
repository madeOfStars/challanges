...
public class ParallelCourses {
    ...
    public static void main(String[] args) {
        ParallelCourses m = new ParallelCourses();
        final int[][] relations1 = {
                {1, 3},
                {2, 3},
        };

        System.out.println(m.minimumSemesters(3, relations1));

        final int[][] relations2 = {
                {1, 2},
                {2, 3},
                {3, 1},
        };

        System.out.println(m.minimumSemesters(3, relations2));
        ...
        System.out.println(m.minimumSemesters(3, relations3));

        final int[][] relations4 = {
                {5, 10},
                {11, 14},
                {21, 22},
                {16, 19},
        ...
        System.out.println(m.minimumSemesters(25, relations4));
    }
}
